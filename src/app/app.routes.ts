...
export const routes: Routes = [
  { path: 'login', component: LoginPageComponent },
  {
    ...
    children: [
      ...
      { path: 'products/new', component: PlaceholderPageComponent, data: { title: 'Nuevo Producto' } },
      { path: 'products/:id', component: PlaceholderPageComponent, data: { title: 'Detalle de Producto' } },
